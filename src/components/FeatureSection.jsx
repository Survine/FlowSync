    ...
    return (
        <div id="features" className="relative mt-20 border-neutral-800 border-b min-h-[800px]">
            <div className="text-center">
                <span className="bg-neutral-900 px-2 py-1 rounded-full h-6 font-medium text-orange-500 text-sm uppercase">
                    Feature
                </span>
            ...
            <div className="flex flex-wrap mt-10 lg:mt-20">
                {features.map((feature, index) => (
                    <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
                        <div className="flex">
                            <div className="flex justify-center items-center bg-neutral-900 mx-6 rounded-full w-10 h-10 text-orange-700">
                                {feature.icon}
                            </div>
                            <div>
